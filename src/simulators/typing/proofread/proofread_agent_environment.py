...
class ProofreadAgentEnv(AgentEnv):
    ...
    def __init__(self, layout_config, agent_params):
        ...
        self.observation_probability = self.free_params["obs_prob"] # agent_params['observation_probability']
    ...
    def move_eyes(self):
        ...
        (mt_enc, mt_exec, mt_enc_l), mt, moved = \
            EMMA_fixation_time(eccentricity / 14, t_prep=self.free_params["emma_t_prep"])
        if moved:
    ...
    def simulate_typing(self):
        ...
        """
        obs_prob = self.free_params["obs_prob"]
        self.error_found = False
    ...
    def set_free_params(self, free_params):
        ...
        self.observation_probability = self.free_params["obs_prob"]
